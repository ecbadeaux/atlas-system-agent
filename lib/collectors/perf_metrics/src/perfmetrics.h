...
class PerfMetrics {
 public:
  PerfMetrics(Reg* registry, const std::string path_prefix);
 ...
 private:
  ...
  static void update_rate(PerfCounter& a, PerfCounter& b, typename Reg::dist_summary_t* ds, const char* name);
